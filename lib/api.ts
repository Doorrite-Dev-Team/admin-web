...
export const api = {
  ...
  approveVendor: (vendorId: string) => {
    return axiosInstance.patch(`/admin/vendors/${vendorId}/approve`, undefined);
  },
  ...
  suspendeVendor: (vendorId: string) => {
    return axiosInstance.patch(`/admin/vendors/${vendorId}/suspend`, undefined);
  },
  ...
  getRiders: (page = 1, limit = 20) => {
    return axiosInstance.get(`/admin/riders`, {
      params: { page, limit },
    });
  },

  approveRider: (riderId: string) => {
    return axiosInstance.patch(`/admin/riders/${riderId}/approve`, undefined);
  },
  ...
  suspendRider: (riderId: string) => {
    return axiosInstance.patch(`/admin/riders/${riderId}/suspend`, undefined);
  },
};
